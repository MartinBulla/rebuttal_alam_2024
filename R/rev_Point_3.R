...
#  requires "rebuttal_fig_2.csv" and generates Fig. 3 of the
#  revision
# =============================================================
...
col_p = 'darkgrey'
col_R = "#D43F3AFF"#'red'#'black'#'red'
col_l = "#D43F3AFF"#'red'#'black'#'red'
...
ggsave(here::here("Output/Fig_3_width-52mm_rev_v2.png"), g, width = 8.5, height = 7.4*8.5/8, unit = "cm")

# not in the manuscript: pre as baseline
...
#  not in the manuscript: post as baseline
