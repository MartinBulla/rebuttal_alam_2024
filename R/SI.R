...
#'- [Dat_path_length.csv](https://github.com/MartinBulla/rebuttal_alam_2024/tree/main/R//DAT_path_length.csv): 20 UMAP iterrations generated from 31 tutored birds of Alam et al.'s Fig 2c (available from https://doi.org/10.18738/T8/WBQM4I/Q92O9A), using Alam et al.'s methods to:  
...
#+ Fig_3, fig.width=8.5*inch, fig.height = inch*7.4*8.5/8
# load data
...
ggsave(here::here("Output/Fig_3_width-52mm_rev_v2.png"), f3, width = 8.5, height = 7.4*8.5/8, unit = "cm")
